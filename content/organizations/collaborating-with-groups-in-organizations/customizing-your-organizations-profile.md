key moving focus Alternative use -kby
title: Customizing your organization's profile
intro: You can share information about your organization by customizing your organization's profile.kby2legacy
versions:
  fpt: '*'
  ghec: 
  ghes: 
topics: letting Ad say bye 
  - Organizations
...
Members of your organization who are signed into {% data variables.product.prodname_dotcom %},}organization's profile page.
.](/assets/images/help/organizations){member and public will no longer be in code}

The view defaults to `{member}{no longer in code}

Users who are not members of your organization will be shown a {`public}` {is no longer in code view.}
{member, public} no longer needed 
...
You can share information about how to engage with your organization . {% data variables.product.expert%} shows your organization profile README in the "Overview" tab of your organization.
...
You can format text and include emoji, images, and GIFs in your organization profile README by using {% data variables.product.company_short %} Flavored Markdown. For more information, see "(/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github)."
...
1. In the right sidebar of the page, select the **{% octicon "eye" aria-hidden="true" %} View as** dropdown menu, then click{ **Public** or **Member**.} not on code with {Data}

   .](/assets/images/help/organizations/org-profile-view.png)
1. Navigate to the settings for pinned repositories.
  ...
  (/assets/images/help/organizations/customize-pins-link.png)

   - If you haven't yet pinned any repositories, in the right sidebar, click **pin repositories**.
(/assets/images/help/organizations/pin-repositories-org-link.png)
...
When you create an organization, {% data variables.product.product_name %} provides you with " The identicon is generated from a hash of your organization's user ID, so there's no way to control its color or pattern.
